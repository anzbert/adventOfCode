...
const inputNoEscapes = `"sjdivfriyaaqa|xd2v|"k|"mpcu|"yyu|"en"
"vcqc"
"zbcwgmbpijcxu|"yins|"sfxn"
"yumngprx"
"bbdj"
...
"|"ynet"
"zh||obk|"otagx|x59txfzf"
"ocowhxlx|xe6zqg|x63wx||tclkhq||vmaze"
"w|"cf"
"qpniprnrzrnvykghqnalr"
"jctcqra|"|x05dhlydpqamorqjsijt||xjdgt"
"sig"
...
const noEscapeArr = inputNoEscapes.split("\n");
const inputArray = input.split("\n");

let countStrings = 0;
noEscapeArr.forEach((string) => (countStrings = countStrings + string.length));
console.log("Raw Strings:", countStrings);

const trimEnds = inputArray.map((string) => string.slice(1, -1));

let countMem = 0;
trimEnds.forEach((string) => (countMem = countMem + string.length));
console.log("Raw Mem:", countMem);

let result = countStrings - countMem;
...
const noEscapeArr2 = inputNoEscapes.split("\n");

let replacedSpecials = noEscapeArr2.map(
  (string) => `"${string.replace(/[^\w]/g, "||")}"`
);

let count2 = 0;
replacedSpecials.forEach((string) => (count2 = count2 + string.length));
console.log("added encoding:", count2);

let result2 = count2 - countStrings;
